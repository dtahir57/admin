            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="CompanyType" class="col-md-4 col-form-label text-md-right">{{ __('Company Type') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="Roles" class="col-md-4 col-form-label text-md-right">{{ __('User Types') }}</label>

                            <div class="col-md-6">
                                <select class="form-control" name="role" required>
                                    <option selected disabled>Please Select an Option</option>
                                    <option value="Register_Site">Register Site</option>
                                    <option value="Developer_User">Developer User</option>
