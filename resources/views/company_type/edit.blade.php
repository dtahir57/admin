...
<div class="card">
  <div class="card-header">Edit Company Type</div>
  <div class="card-body">
    <form action="{{ route('company_type.update', $company_type->id) }}" method="POST">
      <input type="hidden" name="_method" value="PATCH">
    	{{ csrf_field() }}
    	<div class="form-group">
    		<label for="CompanyType">Name</label>
    		<input type="text" name="name" required class="form-control" placeholder="Company Type" value="{{ $company_type->name }}" />
    	</div>
