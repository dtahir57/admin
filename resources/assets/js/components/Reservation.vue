<template>
	<div class="reservation">
		<h3>Non Reservable Event Places ( Visible to only Admin(s) )</h3>
		<draggable :list="eventsAll" :options="{animation: 300, group: 'reservable'}" :element="'div'" class="row" @add="addFunc($event, false)" style="border: 1px solid black; padding: 40px;">
